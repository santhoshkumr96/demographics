...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/createFamilyPage',
          builder: (context, params) => const CreateFamilyPageWidget(),
        ),
        FFRoute(
          name: 'familyDetailsPage',
          path: '/familyDetailsPage',
          builder: (context, params) => FamilyDetailsPageWidget(
            familyIdActual: params.getParam(
              'familyIdActual',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => CreateMemberPageWidget(
            familyIdRef: params.getParam(
              'familyIdRef',
              ParamType.String,
            ),
          ),
