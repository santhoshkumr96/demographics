                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        'https://images.unsplash.com/photo-1617992477211-dfab5866182b?w=512&h=512',
                        width: 100.0,
                        height: 100.0,
                        fit: BoxFit.cover,
                      ),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _model.apiResult3uw = await LoginCall.call(
                                username: _model.textController1.text,
                                password: _model.textController2.text,
                              );

                              if ((_model.apiResult3uw?.succeeded ?? true)) {
                                FFAppState().username = LoginCall.username(
                                  (_model.apiResult3uw?.jsonBody ?? ''),
                                )!;
