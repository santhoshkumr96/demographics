...
import 'family_details_card_model.dart';
export 'family_details_card_model.dart';

class FamilyDetailsCardWidget extends StatefulWidget {
  const FamilyDetailsCardWidget({super.key});

  @override
  State<FamilyDetailsCardWidget> createState() =>
      _FamilyDetailsCardWidgetState();
}

class _FamilyDetailsCardWidgetState extends State<FamilyDetailsCardWidget>
    with TickerProviderStateMixin {
  late FamilyDetailsCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FamilyDetailsCardModel());
